// import { getGirlfriend } from "@/data/ai-data/girlfriend"
import { getProfile } from "@/data/ai-data/profile"
import { getProjects } from "@/data/ai-data/project";
import { getWorkExperience } from "@/data/ai-data/work-experience";
...
export async function POST(request: Request): Promise<Response> {
  ...
  const [projects, profile, experience] = await Promise.all([
    getProjects(),
    // getGirlfriend(),
    getProfile(),
    getWorkExperience()
