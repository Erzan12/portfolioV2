    ...
    <div className="min-h-screen pt-10 md:pt-20 pb-10">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <Card
            id="about"
            className="md:col-span-2 lg:col-span-2 lg:row-span-2 p-6 bg-card border border-border relative overflow-hidden rounded-2xl shadow-none"
          >
          ...
          <Card
            id="experience"
            className="md:col-span-2 lg:col-span-2 p-6 bg-card border border-border relative overflow-hidden rounded-2xl shadow-none flex flex-col justify-center"
          >
          ...
          <Card className="md:col-span-1 lg:col-span-1 p-6 bg-card border border-border relative overflow-hidden rounded-2xl shadow-none">
          ...
          <Card
            id="contact"
            className="md:col-span-1 lg:col-span-1 p-6 bg-card border border-border relative overflow-hidden rounded-2xl shadow-none"
          >
            <div className="relative z-10">
