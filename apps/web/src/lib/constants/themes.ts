export const routeThemeConfig = {
  "/blog": {
    ...
    userBubble: "bg-orange-500/10 border-orange-500/20",
  },
  "/projects": {
    accent: "blue",
    gradient: "from-blue-500/20 to-blue-400/5",
    ring: "ring-blue-500/20",
    userBubble: "bg-blue-500/10 border-blue-500/20",
  },
  "/about": {
    accent: "green",
    gradient: "from-green-500/20 to-green-400/5",
    ring: "ring-green-500/20",
    userBubble: "bg-green-500/10 border-green-500/20",
  },
  "/system-design": {
    accent: "purple",
    gradient: "from-purple-500/20 to-purple-400/5",
    ring: "ring-purple-500/20",
    userBubble: "bg-purple-500/10 border-purple-500/20",
  },
  default: {
    accent: "slate",
    gradient: "from-slate-500/20 to-slate-400/5",
    ring: "ring-slate-500/20",
    userBubble: "bg-slate-500/10 border-slate-500/20",
  },
} as const;
